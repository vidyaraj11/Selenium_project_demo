...
time.sleep(2)
driver.find_element(By.XPATH, "(//input[@id='signInFormUsername'])[2]").send_keys("2zb")
time.sleep(1)
driver.find_element(By.XPATH, "(//input[@id='signInFormPassword'])[2]").send_keys("Hello123#")
time.sleep(1)
driver.find_element(By.XPATH, "(//input[@name='signInSubmitButton'])[2]").click()
time.sleep(3)
driver.find_element(By.XPATH, "(//span[text()='random-test-11']//following-sibling::div//button)[2]").click()
time.sleep(7)
...
driver.find_element(By.XPATH, "(//li[@tabindex='-1'])[3]").click()  # setting option
time.sleep(2)
driver.find_element(By.XPATH, "//span[text()='Firefox']").click()
browser_name_2 = driver.find_element(By.XPATH, "//span[text()='Firefox']").text
print("browser on setting page:", browser_name_2)
time.sleep(3)

driver.find_element(By.XPATH, "//div[@id='version-simple-select-standard']").click()
time.sleep(4)
driver.find_element(By.XPATH, "//li[text()='101.0']").click()

time.sleep(1)
browser_version_2 = driver.find_element(By.XPATH, "(//input[@aria-hidden='true'])").get_attribute("value")

print("browser_version on seting page", browser_version_2)
time.sleep(2)
mannual_session_timeout_2 = driver.find_element(By.XPATH, "//input[@type='number']")
mannual_session_timeout_2.send_keys(Keys.CONTROL + 'a', Keys.BACKSPACE)
time.sleep(1)
mannual_session_timeout_2.send_keys("15")
mannual_session_val_2 = mannual_session_timeout_2.get_attribute("value")
print("manual-session-timeout on setting:", mannual_session_val_2)
time.sleep(2)
session_timeout_2 = driver.find_element(By.XPATH, "//input[@name='session_timeout']")
session_timeout_2.send_keys(Keys.CONTROL + 'a', Keys.BACKSPACE)
session_timeout_2.send_keys("20")
session_val_2 = session_timeout.get_attribute("value")
print("session_timeout on setting page:", session_val_2)
time.sleep(2)
driver.find_element(By.XPATH, "//li[text()='1920x1080']").click()
Resolution_2 = driver.find_element(By.XPATH, "//li[text()='1920x1080']").text
print("resolution on setting page", Resolution_2)
...
driver.find_element(By.XPATH, "//span[text()='Capabilities']").click()
time.sleep(3)
test_name_2 = driver.find_element(By.XPATH, "//input[@id='standard-basic']")
test_name_2.send_keys(Keys.CONTROL + 'a', Keys.BACKSPACE)
time.sleep(1)
test_name_2.send_keys("test_vidya2")
test_name_2_capabilities = driver.find_element(By.XPATH, "//input[@id='standard-basic']").get_attribute("value")
print("test_name=", test_name_2_capabilities)
time.sleep(3)
selected_browser_2 = driver.find_element(By.XPATH, "//span[text()='Firefox']").text
print("browser_name on capabilities page", selected_browser_2)
if browser_name_2 == selected_browser_2:
    print("browser name is matched with setting:", selected_browser_2)
    time.sleep(2)
else:
    print("browser is not matched")
time.sleep(1)

selected_version_2 = driver.find_element(By.XPATH, "//div[text()='99.0']").text
print("browser_version on capabilities page", selected_version_2)
time.sleep(1)
if browser_version_2 == selected_version_2:
    print("browser_version is matched with setting:", browser_version_2)
    time.sleep(2)
else:
    print("browser version is not matched")
time.sleep(1)

selected_resolution_2 = driver.find_element(By.XPATH, "//li[text()='1920x1080']").text
print("selected resolution on capabilities page", selected_resolution_2)
if Resolution_2 == selected_resolution_2:
    print("saved resolution matched:", Resolution_2)
    time.sleep(2)
else:
    print("resolution is not matched")
time.sleep(1)

selected_mannual_session_2 = driver.find_element(By.XPATH, "//input[@type='number']").get_attribute("value")
print("selected mannual session timeout on capabilities page", selected_mannual_session_2)
if mannual_session_val_2 == selected_mannual_session_2:
    print("session timeout matched with saved:", mannual_session_val_2)
    time.sleep(5)
else:
    print("session timeout is not matched")
time.sleep(1)
