...
driver.find_element(By.XPATH, "(//input[@name='username'])[2]").send_keys("vidya5")
time.sleep(1)
driver.find_element(By.XPATH, "(//input[@name='requiredAttributes[name]'])[2]").send_keys("vidya5")
time.sleep(1)
driver.find_element(By.XPATH, "(//input[@type='email'])[2]").send_keys("vidya5@mailinator.com")
time.sleep(1)
...
# time.sleep(3)
driver.find_element(By.XPATH, "//input[contains(@id,'mui')]").send_keys("vidya5")
time.sleep(3)
driver.find_element(By.XPATH, "//button[text()='Create']").click()
time.sleep(10)
