...
def test_login():
    ...
    ('https://5zb:3a29c3069aca45f18551195d8eb1f2df@realme.cloudifytests.io/wd/hub', resolve_ip=True),
...
# driver.maximize_window()
    ...
    driver.find_element(By.XPATH, "(//input[@id='signInFormUsername'])[1]").send_keys("5zb")
    time.sleep(1)
    ...
    print("browser_version on setting page", browser_version)
    time.sleep(2)
